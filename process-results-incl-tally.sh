...
ls results-* |
xargs -I {} node /home/drasync/ProfilingPromisesProcessing/packageResultsToJSON.js --resFile {} --pathTo /home/evaluation/case-studies/$projName/ --antipatterns /data/evaluation/processed-query-results/$projName.csv 
